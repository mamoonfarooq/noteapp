  ...
  */
      ...
      */
      ...
      Editor.prototype.getLinkInfo = function () {
          ...
          if ($anchor.length) {
              ...
              linkInfo.isNewWindow = $anchor.attr('target') === '_self';
          }
          return linkInfo;
      };
      ...
      LinkPopover.prototype.initialize = function () {
          this.$popover = this.ui.popover({
              ...
              callback: function ($node) {
                  ...
                  $content.prepend('<span><a target="_self"></a>&nbsp;</span>');
              }
  ...
  var HelpDialog = /** @class */ (function () {
      ...
      HelpDialog.prototype.initialize = function () {
          ...
          var body = [
              '<p class="text-center">',
              '<a href="http://summernote.org/" target="_self">Summernote 0.8.12</a> · ',
              '<a href="https://github.com/summernote/summernote" target="_self">Project</a> · ',
              '<a href="https://github.com/summernote/summernote/issues" target="_self">Issues</a>',
              '</p>',
          ].join('');
          this.$dialog = this.ui.dialog({
